 ...
 */
final class Version20200531121118 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comentaire ADD ville_id INT DEFAULT NULL, ADD user_id INT DEFAULT NULL');
