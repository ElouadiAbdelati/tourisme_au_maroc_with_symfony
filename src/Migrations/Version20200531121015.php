 ...
 */
final class Version20200531121015 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE comentaire (id INT AUTO_INCREMENT NOT NULL, ville_id INT DEFAULT NULL, user_id INT DEFAULT NULL, comentaire VARCHAR(255) NOT NULL, INDEX IDX_12018917A73F0036 (ville_id), INDEX IDX_12018917A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
